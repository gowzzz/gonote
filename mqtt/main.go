...
func main() {
	topic := flag.String("topic", "aaa", "The topic name to/from which to publish/subscribe")
	broker := flag.String("broker", "tcp://118.89.137.31:1883", "The broker URI. ex: tcp://10.10.1.1:1883")
